...
public class R<T> {
    ...
    public static final String DEF_ERROR_MESSAGE_EN = "System is busy, please try it again";

    public static final String HYSTRIX_ERROR_MESSAGE = "请求超时，请稍候再试";
    public static final String HYSTRIX_ERROR_MESSAGE_EN = "Request timeout, please try it again";
